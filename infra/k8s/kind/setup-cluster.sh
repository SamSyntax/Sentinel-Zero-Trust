...
if ! command -v kind &>/dev/null; then
  ...
  # For AMD64 / x86_64
  [ $(uname -m) = x86_64 ] && curl -Lo ./kind-ex https://kind.sigs.k8s.io/dl/v0.31.0/kind-linux-amd64
  # For ARM64
  [ $(uname -m) = aarch64 ] && curl -Lo ./kind-ex https://kind.sigs.k8s.io/dl/v0.31.0/kind-linux-arm64
  chmod +x ./kind-ex
  sudo mv ./kind-ex /usr/local/bin/kind
fi
